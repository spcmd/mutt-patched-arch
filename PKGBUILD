...
# Git pkg by: spcmd [ github.com/spcmd ]

pkgname=mutt-sidebar-x-gm-labels
pkgver=1.5.23
pkgrel=10
...
conflicts=('mutt')
provides=('mutt')
source=("mutt-1.5.23.tar.gz"
        "trashfolder-1.5.22.diff0.gz"
...
sha512sums=('f1b4a7230253651857f61bd7215cce870a613012f613d4c907d401556083726c8ed7d429d57a8bf858c3b5b23683380d4c1494540d86ca80813e22cb6b95bc1e'
            ...
            '319fb397c235833b1258ccb72ee29d6eea1ffbf5eeb4e8c5e52f8a94d66ec559d62b253d237b4bb30667ac85abf4e0df3049ce1eadc2ad46b8688075a2b9f75d')
...
prepare() {
  ...
  # patch to add Gmail's X-GM-LABELS support 
